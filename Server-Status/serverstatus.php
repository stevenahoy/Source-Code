 ...
 *
 */
$title = "Ahoy Developer Server Status"; // website's title
$servers = array(
    ...
    'Ahoy Developer' => array(
        'ip' => 'ahoydeveloper.esy.es',
        'port' => 80,
        'info' => 'Hosted by IDHostinger',
        'purpose' => 'Domain Server'
    ),
    'Ahoy Ragnarok' => array(
        'ip' => 'ahoy-ragnarok.esy.es',
        'port' => 80,
        'info' => 'Hosted by IDHostinger',
        'purpose' => 'Domain Server'
    )
    'Ragnarok Van Java' => array(
        'ip' => '103.28.148.247',
        'port' => 80,
        'info' => 'Hosted by ID Ragnarok',
        'purpose' => 'Server ID Ragnarok'
    )
...
<center><p> Jika Tabel Berwarna Merah Berarti Server Sedang Mati </p></center>
<center><p> Jika Tabel Berwarna Hijau Berarti Server Sedang Menyala </p></center>
